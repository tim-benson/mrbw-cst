...
// mid-rotation they can transiently read as any band. A new classification is
// committed only after its counter has saturated at this value and then matched
// once more - about 5 consecutive ADC reads with the default of 3.
